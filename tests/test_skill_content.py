...
# across the content tree and summing gives 24 blocks total (2 SKILL.md +
# 8 market-data/README + 2 fundamentals/README + 4 analysis/README +
...
# queries/README.md's `screener(...)` block. The remaining 21 are
...
# --- Domain-original snippets (21), pinned behaviorally --------------------
...
def test_market_data_readme_market_calendar(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    """market-data/README.md: normalized market-wide earnings events."""
    ...
    assert "event_at" in events.columns
